        ...
        return [
            ...
            [
                ...
                'submenu' => [
                    ...
                    ['label' => __('Shrinkage'), 'route' => 'operations.shrinkage', 'pattern' => 'operations/shrinkage*', 'icon' => 'clock'],
                    ...
                    ['label' => __('Excepciones'), 'route' => 'schedules.exceptions', 'pattern' => 'schedules/exceptions*', 'permission' => 'wfm.exceptions.manage', 'icon' => 'exclamation-triangle'],
            ...
            [
                ...
                'submenu' => [
                    ...
                    ['label' => __('Staffing Analysis'), 'route' => 'operations.staffing-analysis', 'pattern' => 'operations/staffing-analysis*', 'icon' => 'users'],
                    ['label' => __('Capacity Analysis'), 'route' => 'operations.capacity-analysis', 'pattern' => 'operations/capacity-analysis*', 'icon' => 'chart-bar'],
                    ...
                    ['label' => __('Data Explorer'), 'route' => 'operations.explorer', 'pattern' => 'operations/explorer*', 'icon' => 'magnifying-glass-circle'],
                ],
            ],
