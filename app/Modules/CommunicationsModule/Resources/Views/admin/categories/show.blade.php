                ...
                <div class="mt-8 bg-white shadow-md rounded-md overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        @if($category->polls->count() > 0)
                            <div class="mb-6">
                                <h3 class="text-lg font-medium text-gray-900 mb-3">Encuestas ({{ $category->polls->count() }})</h3>
                                <div class="space-y-2">
                        ...
                        @if($category->shoutouts->count() > 0)
                            <div class="mb-6">
                                <h3 class="text-lg font-medium text-gray-900 mb-3">Shoutouts ({{ $category->shoutouts->count() }})
                                </h3>
                                <div class="space-y-2">
