<div class="space-y-6">
    <x-wfm.page-header title="Mis Datos (Desempeño Individual)" description="Monitorea tus métricas clave de operación en tiempo real." tour="connect.agent-dashboard" data-tour="agent-dashboard-header">
        <x-slot:actions>
    ...
    @else
        <div data-tour="agent-dashboard-kpis" class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <x-wfm.section title="Registro de Llamadas" description="Detalle de las interacciones recientes." data-tour="agent-dashboard-calls">
