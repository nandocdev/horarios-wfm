...
<section class=" py-4 focus:outline-none" tabindex="-1">
    ...
    <x-core::settings.layout :heading="__('Mi Perfil de Funcionario')" :subheading="__('Gestiona tu información personal e institucional.')">
        <form wire:submit="updateProfileInformation" class="space-y-8 mt-8">
            ...
            <div
                class="bg-slate-50 dark:bg-slate-900 p-4 rounded-md border border-slate-200 dark:border-slate-800 space-y-4">
                ...
                @if ($this->hasUnverifiedEmail)
                    <div
                        class="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-md border border-amber-200 dark:border-amber-800">
                    ...
                    <div class="pt-2 border-t border-slate-200 dark:border-slate-800">
                        <flux:text size="sm" variant="subtle">
                            {{ __('Fecha de Ingreso:') }} <span
                                class="font-medium text-slate-900 dark:text-white">{{ $hire_date }}</span>
                        </flux:text>
                    </div>
                </div>
