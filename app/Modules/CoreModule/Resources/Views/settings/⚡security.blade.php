...
new #[Title('Security settings')] class extends Component {
    ...
    public function updatePassword() {
        ...
        $user->notify(new \App\Modules\CoreModule\Notifications\PasswordChangedNotification());

        $this->reset('current_password', 'password', 'password_confirmation');

        \Flux::toast(
            heading: __('Contraseña actualizada'),
            text: __('Tu contraseña ha sido cambiada exitosamente. Ya puedes navegar en la plataforma.'),
            variant: 'success'
        );
