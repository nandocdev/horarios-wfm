...
<div x-data="{ open: @js($currentFolderId == $folder->id || $folder->children->pluck('id')->contains($currentFolderId)) }">
    <div class="flex items-center group">
        ...
        <div class="flex-1 flex items-center gap-1 py-1 pr-2 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition-colors cursor-pointer {{ $currentFolderId == $folder->id ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-zinc-600 dark:text-zinc-400' }}">
