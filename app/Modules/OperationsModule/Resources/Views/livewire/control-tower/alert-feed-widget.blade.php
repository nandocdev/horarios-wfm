<div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 p-5" wire:poll.60s>
    ...
    <div class="space-y-3">
        @forelse ($alerts as $alert)
            <div class="flex items-start gap-3 p-2.5 rounded-lg {{ $alert['level'] === 'critical' ? 'bg-red-50 dark:bg-red-900/20' : ($alert['level'] === 'warning' ? 'bg-yellow-50 dark:bg-yellow-900/20' : 'bg-zinc-50 dark:bg-zinc-700/50') }}">
                <div class="mt-0.5">
