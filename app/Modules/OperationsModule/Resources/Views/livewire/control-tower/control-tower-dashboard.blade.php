<div data-tour-auto="operations.control-tower">
    ...
    <div data-tour="control-tower-queues" class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
        ...
        <livewire:operations.control-tower.queue-table-widget :employee-ids="$employeeIds"
            :selected-date="$selectedDate" :key="'queues'" wire:key="queues-widget" />
    </div>
    ...
    <div data-tour="control-tower-ops-status" class="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
        ...
        <div class="xl:col-span-1">
            <livewire:operations.control-tower.alert-feed-widget :employee-ids="$employeeIds" :key="'alerts'"
    ...
    <div data-tour="control-tower-charts" class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
        ...
        <livewire:operations.control-tower.sla-asa-chart-widget :employee-ids="$employeeIds"
            :selected-date="$selectedDate" :key="'sla-asa'" wire:key="sla-asa-widget" />
    </div>

    {{-- ROW 5: Adherencia Heatmap | Cobertura --}}
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
        <livewire:operations.control-tower.adherence-heatmap-widget :employee-ids="$employeeIds"
            :selected-date="$selectedDate" :key="'heatmap'" wire:key="heatmap-widget" />
        <livewire:operations.control-tower.coverage-matrix-widget :employee-ids="$employeeIds"
            :selected-date="$selectedDate" :key="'coverage'" wire:key="coverage-widget" />
    </div>
    ...
    <div data-tour="control-tower-forecast" class="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
        ...
        <div class="xl:col-span-1">
            <livewire:operations.control-tower.timeline-widget :selected-date="$selectedDate" :key="'timeline'"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <livewire:operations.control-tower.pending-approvals-widget :key="'pending'" wire:key="pending-widget" />
        <livewire:operations.control-tower.activity-feed-widget :selected-date="$selectedDate" :key="'activity'"
            wire:key="activity-widget" />
        <livewire:operations.control-tower.notification-center-widget :employee-ids="$employeeIds"
            :selected-date="$selectedDate" :key="'notifications'" wire:key="notifications-widget" />
    </div>
</div>