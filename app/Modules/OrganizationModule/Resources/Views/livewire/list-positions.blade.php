            ...
            <div class="overflow-x-auto">
                <flux:table :paginate="$positions">
                    <flux:table.columns class="sticky top-0 z-10 bg-white">
                        ...
                        <flux:table.column class="sticky top-0 z-10 bg-white">Empleados</flux:table.column>
                    ...
                    <flux:table.rows class="hover:bg-slate-50/50 transition-colors duration-150 ease-out">
                        @forelse($positions as $position)
                            <flux:table.row :key="$position->id" class="hover:bg-slate-50/50 transition-colors duration-150 ease-out">
