<form wire:submit="save" class="space-y-8  mx-auto">
    <flux:card class="space-y-4">
        ...
        <div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <flux:input label="Número de empleado *" wire:model="form.employee_number" placeholder="EMP001" />
    ...
    <flux:card class="space-y-4">
        ...
        <div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                @can('salaryEdit', \App\Modules\PersonnelModule\Models\Employee::class)
