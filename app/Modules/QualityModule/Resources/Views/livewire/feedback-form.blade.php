<div class="space-y-6">
    <x-wfm.page-header title="Agregar Feedback" :description="'Evaluación: ' . ($evaluation->queue?->code ?? '') . ' — ' . ($evaluation->dteval?->format('d/m/Y') ?? '')" tour="quality.feedback" data-tour="quality-feedback-header">
        <x-slot:actions>
    ...
    <x-wfm.section data-tour="quality-feedback-form">
