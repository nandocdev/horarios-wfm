...
final class CallStatus
{
    ...
    public function isFinal(): bool { return in_array($this->value, [self::COMPLETED, self::CLOSED, self::FAILED], true); }
    public function isActive(): bool { return ! $this->isFinal(); }

    public static function queued(): self { return new self(self::QUEUED); }
    public static function connected(): self { return new self(self::CONNECTED); }
