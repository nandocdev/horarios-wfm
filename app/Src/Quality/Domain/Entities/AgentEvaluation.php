...
final class AgentEvaluation
{
    ...
    public function evaluatorId(): int { return $this->evaluatorId; }
    public function formId(): int { return $this->formId; }
    public function scores(): array { return $this->scores; }
    public function totalScore(): ?float { return $this->totalScore; }
    public function comments(): ?string { return $this->comments; }
